...
export function placeholderOrganization(id: string, name = 'Agency'): Organization {
  return { id, name, shortName: name, phone: '', email: '', whatsapp: '', code: null, active: true, greeting: null, licenceLabel: null, status: 'active', type: null, country: null, address: null, description: null, logoPath: null, contactName: null, website: null, branding: {}, aiSettings: {}, reminderDays: [30, 14, 7, 1], settings: {}, onboarding: {} }
}
