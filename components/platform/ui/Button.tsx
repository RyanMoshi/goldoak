...
const variants: Record<ButtonVariant, string> = {
  primary: 'bg-gold text-white hover:bg-gold-500',
  forest: 'bg-forest text-white hover:bg-forest-700',
  outline: 'bg-transparent text-ink border border-line hover:bg-surface hover:border-ink-muted',
...
export function ButtonLink({ href, variant = 'outline', size = 'md', className, children }: ButtonLinkProps) {
  return (
