...
/** How to reach the adviser, and the WhatsApp commands the system answers. */
  ...
  return (
    <Card as="section" className="border-forest bg-forest text-white">
      ...
      <div className="mt-5 rounded-card border border-white/15 bg-white/5 p-4 text-[13px]">
        <p className="font-semibold">Check on things from WhatsApp</p>
        ...
        <ul className="mt-2 grid grid-cols-2 gap-1 font-mono text-[12px] text-white/90 sm:grid-cols-5">
          <li>status</li>
          <li>policies</li>
          <li>quotes</li>
          <li>claims</li>
